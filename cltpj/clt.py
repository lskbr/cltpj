...
class CLT:
    def __init__(self, salario):
        ...
        self.ir_ferias = (ir(self.salario * 1.3) - self.irpf) / 12
        self.base_decimo_terceiro = self.salario * 2 - inss(self.salario * 2)
        self.ir_decimo_terceiro = (ir(self.base_decimo_terceiro) - self.irpf) / 12
    ...
    Impostos             - {self.impostos:12,.2f}
                         ==============
    Liquido                {self.mensal-self.indireto:12,.2f}
    Benefícios           + {self.indireto:12,.2f}
                         ==============
    Liquido + Benefícios   {self.mensal:12,.2f}
            """
